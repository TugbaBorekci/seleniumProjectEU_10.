...
public class T1_StaleElementsRefEx {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);//burda sllep kismi hata veriyor yazinca sag click yapip add exception to method signature yap duzelmesi icin
        addElementBtn.click();

        //4. Verify “Delete” button is displayed after clicking.
        WebElement deleteButton = driver.findElement(By.xpath("// button[@class='added-manually']"));

        System.out.println("deleteButton.isDisplay()= " + deleteButton.isDisplayed() );
        ...
        try {
            ...
            System.out.println("deleteButton.isDisplay()= false");
        }
        driver.close();
